...
hosts="r1.apiv3 r2.apiv3 r3.apiv3 w1.apiv3 w2.apiv3 udp.apiv3 web1.apiv3 web2.apiv3 redis.apiv3 chronos1 chronos2"
...
for host in `echo $hosts | tr ' ' '\n'`; do
    ...
    sudo -u errplane errplane-config-generator -api-key 962cdc9b-15e7-4b25-9a0d-24a45cfc6bc1 -app-key 3abb351e -http-host w.staging.apiv3.errplane.com \
