...
curl -v -X POST 'http://c.staging.apiv3.errplane.com/databases/app4you2loveproduction/agent/r2.apiv3/configuration?api_key=962cdc9b-15e7-4b25-9a0d-24a45cfc6bc1' --data @- <<EOF
{
  "processes":[{"name":"chronos_server","regex":".*chronos_server.*chronos_server_config.*json.*","status":"regex","start":"/mnt/data-collector/bin/start.sh chronos_server","user":"ubuntu"}]
}
EOF

curl -v -X POST 'http://c.staging.apiv3.errplane.com/databases/app4you2loveproduction/agent/r3.apiv3/configuration?api_key=962cdc9b-15e7-4b25-9a0d-24a45cfc6bc1' --data @- <<EOF
{
  "processes":[{"name":"chronos_server","regex":".*chronos_server.*chronos_server_config.*json.*","status":"regex","start":"/mnt/data-collector/bin/start.sh chronos_server","user":"ubuntu"}]
}
EOF

curl -v -X POST 'http://c.staging.apiv3.errplane.com/databases/app4you2loveproduction/agent/w1.apiv3/configuration?api_key=962cdc9b-15e7-4b25-9a0d-24a45cfc6bc1' --data @- <<EOF
{
  "processes":[{"name":"data_collector","regex":".*data_collector.*data_collector_server_config.*json.*","status":"regex","start":"/mnt/data-collector/bin/start.sh data_collector_server","user":"ubuntu"}]
}
EOF

curl -v -X POST 'http://c.staging.apiv3.errplane.com/databases/app4you2loveproduction/agent/w2.apiv3/configuration?api_key=962cdc9b-15e7-4b25-9a0d-24a45cfc6bc1' --data @- <<EOF
{
  "processes":[{"name":"data_collector","regex":".*data_collector.*data_collector_server_config.*json.*","status":"regex","start":"/mnt/data-collector/bin/start.sh data_collector_server","user":"ubuntu"}]
}
EOF
